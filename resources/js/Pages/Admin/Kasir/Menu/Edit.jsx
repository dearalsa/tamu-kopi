...
export default function Edit({ categories, menu }) {
  ...
  const { data, setData, post, processing, errors } = useForm({
    ...
    is_best_seller:
      menu.is_best_seller === null || menu.is_best_seller === undefined
        ? ''
        : menu.is_best_seller
        ? 1
        : 0,
  ...
  const handleSubmit = (e) => {
    e.preventDefault();
    post(route('admin.kasir.menus.update', menu.id), {
      forceFormData: true,
      preserveScroll: true,
    });
  };
          ...
          <div className="bg-white rounded-[30px] border border-gray-200 shadow-[0_18px_45px_rgba(15,23,42,0.08)]">
            <form onSubmit={handleSubmit} className="p-10 space-y-8">
              ...
              <div className="space-y-3">
                ...
                <div className="relative">
                  <span className="pointer-events-none absolute inset-y-0 left-0 flex items-center pl-3 text-gray-400">
                    {String(data.is_available) === '1' ? <Check className="w-4 h-4" /> : <XIcon className="w-4 h-4" />}
                  </span>
                  <select
              ...
              <div className="space-y-3">
                ...
                <div className="relative">
                  <select
                    ...
                    onChange={(e) => setData('is_best_seller', e.target.value === '' ? '' : Number(e.target.value))}
                    ...
                    <>
                      ...
                      <div className="absolute inset-0 bg-black/15 flex items-center justify-center">
                        <button
                          type="button"
                          onClick={removeImage}
                          className="bg-black/60 text-white rounded-full p-2 hover:bg-red-500"
                        >
                          <XIcon size={16} />
                        </button>
                      </div>
              ...
              <div className="pt-2">
                <button
                  type="submit"
                  disabled={processing}
                  className="w-full bg-[#EF5350] text-white font-sfPro py-4 rounded-xl text-sm hover:bg-[#e53935] active:scale-[0.98] transition-all disabled:opacity-50 font-normal"
                >
