        ...
        <div className="grid grid-cols-1 md:grid-cols-4 gap-10 mb-10 items-start">
          ...
          <div>
            ...
            <nav className="flex flex-col gap-2.5">
              <Link href="/" className="text-[13px] hover:text-[#DE0F38] transition-colors w-fit">Beranda</Link>
              <Link href="/menu" className="text-[13px] hover:text-[#DE0F38] transition-colors w-fit">Menu</Link>
              <button onClick={() => handleScrollOrLink("about")} className="text-left text-[13px] hover:text-[#DE0F38] transition-colors w-fit">Tentang Kami</button>
              <button onClick={() => handleScrollOrLink("contact")} className="text-left text-[13px] hover:text-[#DE0F38] transition-colors w-fit">Kontak</button>
            </nav>
          </div>
          ...
          <div>
            ...
            <div className="space-y-2.5 mb-5">
                <a href="mailto:rumu.kopi@gmail.com" className="block text-[13px] hover:text-[#DE0F38] transition-colors">rumu.kopi@gmail.com</a>
                <a href="https://wa.me/6289759512" target="_blank" rel="noopener noreferrer" className="block text-[13px] hover:text-[#DE0F38] transition-colors"
                >
                +62 8975 9512
                </a>
                </div>
            ...
            <div className="flex gap-2.5">
              <a href="https://instagram.com/tamu_kopi" target="_blank" rel="noopener noreferrer" className="w-8 h-8 border border-gray-200 rounded-full flex items-center justify-center text-gray-500 hover:text-white hover:bg-[#3B1F1A] hover:border-[#0000] transition-all duration-300">
              ...
              <a href="https://tiktok.com/@tamu.kopi" target="_blank" rel="noopener noreferrer" className="w-8 h-8 border border-gray-200 rounded-full flex items-center justify-center text-gray-500 hover:text-white hover:bg-[#3B1F1A] hover:border-[#0000] transition-all duration-300">
