        ...
        <div className="grid grid-cols-1 md:grid-cols-4 gap-10 mb-10 items-start">
          ...
          <div>
            ...
            <div className="space-y-2.5 mb-5">
              ...
              <p className="text-[13px]">+62 8975 9512</p>
            </div>
            <div className="flex gap-2.5">
              ...
              <a href="https://tiktok.com/@tamu.kopi" target="_blank" rel="noopener noreferrer" className="w-8 h-8 border border-gray-200 rounded-full flex items-center justify-center text-gray-400 hover:text-white hover:bg-[#3B1F1A] hover:border-[#3B1F1A] transition-all duration-300">
