    ...
    <>
      <header 
        className={`w-full fixed top-0 left-0 right-0 z-50 transition-all duration-300 ${
          scrolled || open ? "bg-[#F8F3F3]/95 backdrop-blur-md shadow-sm" : "bg-[#F8F3F3]"
        }`}
      >
        <div className="max-w-7xl mx-auto flex items-center justify-between px-6 sm:px-10 py-4">
          ...
          <nav className="hidden md:flex gap-10 text-[16px] font-poppinsBold text-[#3B1F1A] items-center">
            <Link href="/" className="hover:text-[#E84949] transition-colors duration-300">
              {t("home")}
            </Link>
            <Link href="/menu" className="hover:text-[#E84949] transition-colors duration-300">
              {t("menu")}
            </Link>
            <button 
      ...
      >
        ...
        <nav className="flex flex-col items-start px-10 mt-6 gap-10 text-[16px] font-poppinsBold text-[#3b2f2f]">
          <Link 
            href="/" 
            onClick={() => setOpen(false)} 
            className="w-full hover:text-[#E84949] transition-colors duration-300 active:text-[#E84949]"
          >
            {t("home")}
          </Link>
          <Link 
          ...
          <button 
            onClick={() => handleScrollOrLink("about")} 
            className="w-full text-left hover:text-[#E84949] transition-colors duration-300 active:text-[#E84949]"
          >
            {t("about")}
          </button>
          <button 
